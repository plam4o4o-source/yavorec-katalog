...
`electron-app/src/udk.js`) е работна подборка по официалното национално издание
на УДК, 2017 г. (Национална библиотека „Св. св. Кирил и Методий“ в
сътрудничество с UDC Consortium) и по **Multilingual UDC Summary** (UDCC
Publication No. 088, UDC Consortium). УДК Summary е публикувана от UDC
