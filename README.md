...
**Таблицата на УДК** (`electron-app/src/udk.json`, от която се прави
`electron-app/src/udk.js`) е официалният **съкратен указател** — 1920 основни
кода и 739 общи определителя — по **Multilingual UDC Summary** (UDCC Publication
No. 088, UDC Consortium), българска версия, хармонизирана с официалното
национално издание на УДК от 2017 г. (Национална библиотека „Св. св. Кирил и
Методий“ в сътрудничество с UDC Consortium). УДК Summary е публикувана от UDC
Consortium под [Creative Commons Attribution-ShareAlike
3.0](https://creativecommons.org/licenses/by-sa/3.0/) — затова се разпространява
заедно с програмата, **с посочване на източника и при същия лиценз**. Пълната
схема на УДК (над 70 000 индекса) остава лицензирана собственост на консорциума
и НЕ е тук. Кодовете в `additions` на същия файл не идват оттам — те са от
собствената съкратена таблица на проекта (GPL-3.0) и са отбелязани отделно.

> **Проверка на лиценза (8.09.2026 г.).** Подаден вариант на данните твърдеше
> „CC BY-NC 4.0, считано от 2026 г.“. Проверено по
> [страницата за лицензите на консорциума](https://udcc.org/index.php/site/page?view=publishing_licence)
> и по [udcdata.info](https://udcdata.info/) — и двете сочат **CC BY-SA 3.0**, без
> следа от промяна към NonCommercial. Затова тук е записано CC BY-SA 3.0.
> Разликата не е дребна: **NonCommercial е несъвместим с GPL-3.0**, и ако
> лицензът наистина се смени на NC, таблицата трябва да излезе от хранилището и
> да се внася от файл на библиотеката, както авторската таблица. Следата от
> проверката се пази в `meta.license_check` и в главата на `src/udk.js`.

**Авторската таблица** (двузначните числа за авторския знак) е чуждо печатно
издание и **не се разпространява с програмата** — библиотеката внася веднъж
своя файл от „Настройки → Фонд → Авторски знак“. В хранилището няма нито един
ред от нея.
