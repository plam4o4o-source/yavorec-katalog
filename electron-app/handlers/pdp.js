...
module.exports = function registerPdpHandlers(ipcMain, deps) {
  ...
  /* Освен КОИ полета са скрити, редът носи и ЗАЩО. Причината идва ОТТУК, вместо
     ...
     различни, защото поправката им е различна:
       ...
       • 'stale'      — сесията е обявена за негодна, защото паролата е сменена от
                        ДРУГО работно място, докато тази е била отворена. Данните са
                        напълно здрави: отключването наново с НОВАТА парола ги връща
                        (pdp:unlock нулира PDP_STALE).
