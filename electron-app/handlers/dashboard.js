  ...
  ipcMain.handle('dashboard:full', () =>
    run(() => {
      ...
      /* Заеманията по седмици за последните 12 седмици — посоката, която едно число
         ...
         никога не го виждат: заемането изчезва от графиката, от „N заемания тази
         седмица“ и от сбора, с който тестът сверява независимо преброените 84 дни.
      ...
      /* Прозорецът е определен на ЕДНО място — в границите на заявката по-горе,
         вече верни за самите 84 дни. Пазачът `w>=0 && w<12`, премахнат в прегледа на
         v2.4.52 с извод „SQL вече отрязва“: вярно е, СЕГА — но границата тогава
         имаше грешка от един ден (виж по-горе), а пазачът само би СКРИЛ загубата
         (седмицата пропада тихо), не би я поправил. Коренът е границата на
         заявката, не липсваща втора проверка. */
