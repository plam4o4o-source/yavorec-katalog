...
test('имейлът/SMS-ът (loans:reminders) иска СЪЩАТА сума като писмото и гишето', async () => {
  ...
  /* v2.4.51: обезщетението е записано в ЕВРО и писмото не го дели повторно —
     дотук имейлът, SMS-ът и хартиеното напомняне даваха три различни числа за
     едно задължение. Левът остава справочно в скоби. */
  assert.match(rem.data[0].body, /2\.05 € \(4\.01 лв\.\)/, 'и текстът на писмото носи истинската сума');
});
