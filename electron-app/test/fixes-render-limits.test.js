  ...
  /* Излишният бутон е влошаване: библиотекарят търси нещо, което го няма отвъд
     ...
     СЪЗНАТЕЛНО не се слага там, където броят редове е ограничен по устройство:
       ...
       periodicals.js— списъкът е от ЗАГЛАВИЯ на периодични издания (десетки),
                       а не от броеве; броевете са число в колона. Самите броеве
                       (кардексът в прозореца на изданието) ДА растат — при
                       ежедневник с по 300+ на година, — но от v2.4.61 те вече не
                       се чертаят наведнъж: periodicals:get връща броевете на
                       ЕДНА година (по подразбиране текущата), а прозорецът има
                       избор на година, търсачка по номер/дата и надпис „Показани
                       N от M“. Разрезът е по ГОДИНА, защото и хартиеният кардекс,
                       и подвързването на комплекта са по година — тоест
                       прозоречен рендер („Покажи още“) тук би бил втори, по-слаб
                       отговор на вече решен въпрос;
