...
не открива файла (проверено и поправено). Заглавието на прозореца вече е
„InvLib · Библиотечна система“, но `productName` в конфигурацията остава
„Инвентар“ нарочно — то определя инсталационния файл, преките пътища и
записа в „Приложения“ на Windows, а смяната му би преименувала папката с
инсталираната програма при вече монтирани библиотеки (не и папката с
данните — виж `docs/ARCHITECTURE.md`).
