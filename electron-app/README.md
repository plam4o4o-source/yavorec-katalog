...
| Настройки | данни за библиотеката, параметри на обслужването, постоянна комисия, 6 цветови теми, местоположение на базата данни (локална мрежа), резервни копия |
