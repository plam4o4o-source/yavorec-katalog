...
| Дневник | месечен статистически дневник — Раздел А (читатели и посещения) и Раздел Б (заети материали), по образец на e_Dnevnik_AB_CH2; ред за всеки календарен ден, месечни и годишни (от началото на годината) тотали, изчислени автоматично |
...
| Настройки | данни за библиотеката, параметри на обслужването, постоянна комисия, 6 цветови теми, местоположение на базата данни (локална мрежа), служители, резервни копия |
