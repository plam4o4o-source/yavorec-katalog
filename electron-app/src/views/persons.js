...
async function savePerson(id) {
  ...
  /* ПРЕДУПРЕЖДЕНИЕ ЗА ВЕЧЕ ВПИСАНО ИМЕ (v2.4.65, находка Б20).
     =======================================================================
     ДОТУК три картона „Вълчев, Стефан“ влизаха без нито една дума, всеки със
     свои връзки към документи, статии и летописни записи — и краеведската
     справка за човека се оказваше разделена на три, без нито една пълна.
     Питането е ТУК, на екрана, защото ОТКАЗ не бива да има: съименниците в едно
     село са правило, а картотеката няма по какво да ги различи, когато датите на
     раждане са неизвестни. Границата (следата в дневника) е в обработчика —
     handlers/persons.js, persons:create, — а екранът само пита по-рано и с думи,
     по общото правило на проекта.
     Проверката минава през СЪЩЕСТВУВАЩИЯ канал persons.list: той вече търси през
