...
//
// Всеки списък стойности е извлечен от истинския избор в src/app.js
// (действителният избор на потребителя), НЕ от коментарите в db/schema.sql —
// двете вече се бяха разминали на две места: books.status в коментара нямаше
// „отчислен" (задава се от handlers/deaccession-acts.js), а chronicle.category
// в коментара нямаше „юбилей" (CHR_CATS в src/app.js).
//
